...
# Principled three-axis qualification rule. The legacy six-gate classifier above
# is retained for backward-compatible reproduction of published analyses.
from .decision import IUTConfig, CoreEvidenceState, EvidenceDeficit, classify_iut, global_iut_type1_bound
